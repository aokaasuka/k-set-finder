                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="drama_title" name="drama_title" value="<?= set_value('drama_title'); ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="scene" name="scene" style="height: 100px" value="<?= set_value('scene'); ?>"></textarea>
                                    <?= form_error('scene', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="location_address">Location address:</label>
                                    <textarea class="form-control" id="location_address" name="location_address" style="height: 100px" value="<?= set_value('location_address'); ?>"></textarea>
                                ...
                                <div class="mb-3">
                                    <label for="drama_title">Street view:</label>
                                    <input type="text" class="form-control" id="street_view" name="street_view" value="<?= set_value('street_view'); ?>">
...
<script>
    ...
    var currentLocation = [36.55486506323537, 127.8547037445218];
